...
public class ServletMonProfil extends HttpServlet implements Servlet {
	...
	/**
	 * accessible via le lien url dans la navbar "Mon Profil" cette servlet permet
	 * de v�rifier si la session utilisateur est toujours active avanyt de rediriger
	 * vers la page monProfil.jsp
	 * 
