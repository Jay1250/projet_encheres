                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title text-left">
                                        ...
                                        %>
                                            ...
                                            <a href="<%=request.getContextPath()%>/Profil?userId=<%=u.getNoUtilisateur()%>&choices=<%=choix1%>" class="card-link">
                                                <%=u.getPseudo()%>
                                            </a>
                                        <% } %>
                                    </h5>
                                    <h5 class="card-title text-right">
                                        <a href="<%=request.getContextPath()%>/Vente?saleId=<%=v.getNoVente()%>&choices=<%=choix1%>">détails</a>
                                    </h5>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card col-md-12 block-info-vente">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title text-left">
                                        ...
                                        %>
                                            <%=e.getMontantEnchere()%> par :
                                            <a href="<%=request.getContextPath()%>/Profil?userId=<%=u.getNoUtilisateur()%>&choices=<%=choix1%>"
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title text-left">
                                        ...
                                        <% } else {
                                            ...
                                            Enchere e = encheresAutresVentes.get(encheresAutresVentes.indexOf(v));
                                        ...
                                        %>
                                            <%=e.getMontantEnchere()%> par :
                                            <a href="<%=request.getContextPath()%>/Profil?userId=<%=u.getNoUtilisateur()%>&fromChoices=<%=choix1%>" class="card-link">
                                                <%=u.getPseudo()%>
                                            </a>
                                        <% } %>
                                    </h5>
                                    <h5 class="card-title text-right">
                                        <a href="<%=request.getContextPath()%>/Vente?saleId=<%=v.getNoVente()%>&fromChoices=<%=choix1%>">détails</a>
                                    </h5>
                                </div>
                            </div>
                        </div>
